...
const Projects = () => {
  ...
  return (
    <div className='w-full'>
          <div className='w-full h-[70vh] bg-cover bg-center flex flex-col justify-center items-center gap-5 relative ' style={{ backgroundImage: `url(${project})` }}>
                <h1 className="text-white text-4xl font-bold uppercase text-center pt-20 lg:text-6xl z-10">Our Projects</h1>
                <div className='z-10'>
                    <Breaker />
                </div>

                <p className='text-white z-10'>Take a look our Projects and explore our work</p>
