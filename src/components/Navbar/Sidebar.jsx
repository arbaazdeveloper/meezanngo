    ...
    <div className={`fixed inset-0 z-50 ${isOpen ? 'block' : 'hidden'}`}>
      ...
      <div className='w-full flex justify-end '>
            <ul className='flex gap-10 flex-col items-end justify-end w-full '>
              ...
              <li><Link onClick={toggleSidebar} className={`font-bold text-3xl  text-white transition-all duration-100 hover:text-[#fdd65b] ${isPathActive('/projects') && '!text-[#fdd65b]'}`} to='/projects'>Projects</Link></li>
